...
trait ApplicationTrait {
    ...
    protected $_exceptionsClassMap = [
        ...
        Application::DB_EXCEPTION => \yii\db\Exception::class,
        Application::CONSOLE_EXCEPTION => \yii\console\Exception::class,
        ...
        Application::INVALID_PARAM_EXCEPTION => InvalidParamException::class,
