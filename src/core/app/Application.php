...
use core\api\rest\session\RedisSession;
use core\api\rest\User;
use core\os\SystemCommandManager;
use DIT\Service\Setting\Manager;
 ...
 * @property int $loadedModules list of loaded modules indexed by their class names.
 *
 ...
 * read-only.
 * @property ManagerInterface $authManager The auth manager application component. Null is returned
 ...
 * @property MailerInterface $mailer The mailer application component. This property is read-only.
 ...
 * @property DbSession|RedisSession $session The session component. This property is read-only.
 * @property SettingsManager|array $settings
 * @property Manager|array $ditSettings
